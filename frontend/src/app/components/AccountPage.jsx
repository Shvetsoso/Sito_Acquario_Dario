  ...
  const orders = [
    {
      ...
      items: [
        {
          name: "Acquario Orizzonte 100",
          qty: 1,
          img: "https://images.unsplash.com/photo-1542345647781-7c1c1350f7fb?q=80&w=200",
        },
        {
          name: "Filtro CrystalFlow Pro",
          qty: 1,
          img: "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?q=80&w=200",
        },
      ],
    },
    {
      ...
      items: [
        {
          name: "Mangime Tropical Mix",
          qty: 2,
          img: "https://images.unsplash.com/photo-1522069169874-c58ec4b76be5?q=80&w=200",
        },
      ],
    },
  ];
          ...
          <main className="lg:col-span-3 space-y-8">
            <div className="bg-black/20 backdrop-blur-md p-6 rounded-2xl border border-white/10">
              ...
              <p className="text-blue-100/60">
                Gestisci i tuoi acquisti e monitora le spedizioni in tempo
                reale.
              </p>
            </div>
                ...
                >
                  <div className="p-6 border-b border-white/10 bg-white/5 flex flex-wrap justify-between items-center gap-4">
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-sm text-blue-100/50 font-medium">
                        {order.id}
                      </span>
                    </div>
                    <div className="flex gap-6 text-sm">
                      <div>
                        <span className="block text-xs text-blue-200/40 uppercase font-bold">
                          Data Ordine
                        </span>
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-10 pt-8 border-t border-white/10 flex flex-wrap justify-between items-end gap-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="text-xs text-blue-200/40 font-bold uppercase tracking-widest">
                            Arrivo previsto
                          </p>
