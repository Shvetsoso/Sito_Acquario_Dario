          ...
          >
            <div className="p-6 border-b border-slate-100 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-xl font-bold text-slate-900">Il Tuo Carrello</h2>
              </div>
            ...
            <div className="flex-1 overflow-y-auto p-6">
              {items.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center">
                  ...
                  <h3 className="text-lg font-bold text-slate-800">Il carrello è vuoto</h3>
                  <p className="text-slate-500 mb-6">Non hai ancora aggiunto prodotti al carrello.</p>
                  <button 
                    onClick={onClose}
            ...
            {items.length > 0 && (
              <div className="p-6 border-t border-slate-100 bg-slate-50">
                ...
                <p className="text-xs text-slate-500 mb-6">Spedizione calcolata al checkout.</p>
